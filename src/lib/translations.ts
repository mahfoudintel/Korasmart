...
export const translations: Record<string, { fr: string; ar: string; en?: string }> = {
  ...
  "Choose a screenshot first.": { fr: "Choisissez d'abord une capture.", ar: "اختر الصورة أولا." },
  "Read image": { fr: "Lire l'image", ar: "قراءة الصورة" },
  "Reading image": { fr: "Lecture image", ar: "قراءة الصورة" },
  "Reading screenshot...": { fr: "Lecture de la capture...", ar: "جار قراءة الصورة..." },
  "OCR could not read this image. Paste the text or add rows manually.": {
    fr: "OCR n'a pas pu lire cette image. Collez le texte ou ajoutez les lignes manuellement.",
    ar: "تعذر على OCR قراءة هذه الصورة. الصق النص أو أضف الصفوف يدويا."
  },
  ...
  "Edit stats": { fr: "Modifier stats", ar: "تعديل الإحصائيات" },
  Edit: { fr: "Modifier", ar: "تعديل" },
  "Edit attendance": { fr: "Modifier presence", ar: "تعديل الحضور" },
  "Edit teams": { fr: "Modifier equipes", ar: "تعديل الفرق" },
  "Edit key stats": { fr: "Modifier stats cles", ar: "تعديل الإحصائيات المهمة" },
  "Stop editing": { fr: "Arreter modification", ar: "إيقاف التعديل" },
  "Team A score": { fr: "Score equipe A", ar: "نتيجة الفريق أ" },
  "Team B score": { fr: "Score equipe B", ar: "نتيجة الفريق ب" },
  Winner: { fr: "Gagnant", ar: "الفائز" },
  "Players and teams": { fr: "Joueurs et equipes", ar: "اللاعبون والفرق" },
  "Players and scorers": { fr: "Joueurs et buteurs", ar: "اللاعبون والهدافون" },
  "No team": { fr: "Sans equipe", ar: "بدون فريق" },
  "Save stats": { fr: "Enregistrer stats", ar: "حفظ الإحصائيات" },
  "Save teams": { fr: "Enregistrer equipes", ar: "حفظ الفرق" },
  "Stats saved.": { fr: "Stats enregistrees.", ar: "تم حفظ الإحصائيات." },
  "Could not save stats.": { fr: "Impossible d'enregistrer les stats.", ar: "تعذر حفظ الإحصائيات." },
  "Attendance updates save immediately.": {
    fr: "Les modifications de presence sont enregistrees immediatement.",
    ar: "يتم حفظ تعديلات الحضور فورا."
  },
  ...
  Lock: { fr: "Verrouiller", ar: "قفل" },
  Unlock: { fr: "Deverrouiller", ar: "فتح القفل" },
  Pending: { fr: "En attente", ar: "قيد الانتظار" },
  "Teams locked.": { fr: "Equipes verrouillees.", ar: "تم قفل الفرق." },
  "Teams unlocked.": { fr: "Equipes deverrouillees.", ar: "تم فتح قفل الفرق." },
  "Team sheet ready": { fr: "Feuille d'equipe prete", ar: "ورقة الفرق جاهزة" },
  "Generate teams from attendance": { fr: "Generer les equipes depuis la presence", ar: "توليد الفرق من الحضور" },
  "Admin dashboard": { fr: "Tableau admin", ar: "لوحة الإدارة" },
  "Match readiness": { fr: "Preparation du match", ar: "جاهزية المباراة" },
  "Missing responses": { fr: "Reponses manquantes", ar: "الردود الناقصة" },
  "Action list": { fr: "Liste d'actions", ar: "قائمة الإجراءات" },
  "Follow up missing attendance.": { fr: "Relancer les presences manquantes.", ar: "تابع الحضور الناقص." },
  "Attendance is ready.": { fr: "La presence est prete.", ar: "الحضور جاهز." },
  "Teams are locked.": { fr: "Les equipes sont verrouillees.", ar: "الفرق مقفلة." },
  "Review and lock teams.": { fr: "Verifier et verrouiller les equipes.", ar: "راجع الفرق واقفلها." },
  "Generate and save teams.": { fr: "Generer et enregistrer les equipes.", ar: "ولد الفرق واحفظها." },
  "Review payments and booking costs.": { fr: "Verifier paiements et frais de reservation.", ar: "راجع الدفعات وتكاليف الحجز." },
  "Improve peer ratings for fair teams.": { fr: "Ameliorer les notes pour des equipes justes.", ar: "حسن التقييمات لفرق عادلة." },
